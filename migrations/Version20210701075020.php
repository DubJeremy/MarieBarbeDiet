 ...
 */
final class Version20210701075020 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE post (id INT AUTO_INCREMENT NOT NULL, user_category_id INT NOT NULL, title VARCHAR(255) DEFAULT NULL, content LONGTEXT DEFAULT NULL, picture VARCHAR(255) DEFAULT NULL, updated DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, INDEX IDX_5A8A6C8DBB5D5477 (user_category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE recipe (id INT AUTO_INCREMENT NOT NULL, difficulty_id INT DEFAULT NULL, user_category_id INT NOT NULL, title VARCHAR(255) DEFAULT NULL, recipe LONGTEXT NOT NULL, picture VARCHAR(255) DEFAULT NULL, updated DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, preparation_time DATETIME DEFAULT NULL, ingredient LONGTEXT DEFAULT NULL, INDEX IDX_DA88B137FCFA9DAE (difficulty_id), INDEX IDX_DA88B137BB5D5477 (user_category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, user_category_id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, joined_on DATETIME NOT NULL, profile_picture VARCHAR(255) DEFAULT NULL, updated DATETIME DEFAULT NULL, age DATETIME NOT NULL, height VARCHAR(255) NOT NULL, weight VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649BB5D5477 (user_category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
